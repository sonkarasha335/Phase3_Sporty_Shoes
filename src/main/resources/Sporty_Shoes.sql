...
reportPrice int(20));
insert into purchase_report values(1,"Strickrer","sonkarasha335@gmail.com","18-10-2000",399);
...
insert into user values(1,"Asha","sonkarasha335@gmail.com",22,"Female","Uttarakhand");
select * from user;
